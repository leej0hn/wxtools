package com.redscarf.wxtools.service.aop;

import com.google.common.base.Throwables;
import com.redscarf.wxtools.common.exception.ServiceException;
import com.redscarf.wxtools.common.vo.Response;
...
public class ServiceLogAspect {
     ...
     * @param joinPoint
     */
    @Before("execution(* com.redscarf.wxtools.service.impl.*.*(..))")
    ...
    @Around("execution(* com.redscarf.wxtools.service.impl.*.*(..))")
     ...
     * @param reponse
     */
    @AfterReturning(value ="execution(* com.redscarf.wxtools.service.impl.*.*(..))",returning = "reponse")
