package com.redscarf.wxtools.web.aop;
...
public class WebLogAspect {
    ...
    @Before("execution(* com.redscarf.wxtools.web.controller..*(..))")
     ...
     * @param reponse
     */
    @AfterReturning(value = "execution(* com.redscarf.wxtools.web.controller..*(..)) or execution(* com.redscarf.wxtools.web.exception..*(..))",returning = "reponse")
